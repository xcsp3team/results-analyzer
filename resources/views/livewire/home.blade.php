<div class="h-screen">
    ...
    <div
        ...
        <h2 class="text-2xl mb-6">Select an evaluation</h2>
        <select wire:model="evaluation" wire:change="load"
                class="block w-1/3 px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body">
