<div class="dark:bg-gray-800">
    <h4 class="h3">Filtering constraints</h4>
    <div>
        <form wire:submit="save">

            <div class="flex items-center mb-4">
                <input id="default-radio-1" type="radio" wire:model="forbidden" value="0"
                       class="dark:border-gray-400 w-4 h-4 text-neutral-primary border-default-medium bg-neutral-secondary-medium rounded-full checked:border-brand focus:ring-2 focus:outline-none focus:ring-brand-subtle border border-default appearance-none">
